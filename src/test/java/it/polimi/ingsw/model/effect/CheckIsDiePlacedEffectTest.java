...
class CheckIsDiePlacedEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        CheckIsDiePlacedEffect checkIsDiePlaced= new CheckIsDiePlacedEffect("checkIsDiePlaced");
        checkIsDiePlaced.setToolCard(toolCardMock);
        checkIsDiePlaced.perform(toolCardMock.getRound().getTurns().get(1));
        assertTrue(toolCardMock.isEverythingOk());
        toolCardMock.round.getTurn().setDiePlaced();
        checkIsDiePlaced.perform(toolCardMock.round.getTurn());
