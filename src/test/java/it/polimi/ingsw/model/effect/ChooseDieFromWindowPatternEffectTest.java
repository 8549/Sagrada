...
class ChooseDieFromWindowPatternEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        ChooseDieFromWindowPatternEffect chooseDieFromWindowPatternEffect = new ChooseDieFromWindowPatternEffect("chooseDieFromWindowPattern");
        chooseDieFromWindowPatternEffect.setToolCard(toolCardMock);
        chooseDieFromWindowPatternEffect.perform(true, true);
