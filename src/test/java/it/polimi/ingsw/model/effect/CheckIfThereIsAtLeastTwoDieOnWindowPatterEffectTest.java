...
class CheckIfThereIsAtLeastTwoDieOnWindowPatterEffectTest {

    @Test
    void perform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        CheckIfThereIsAtLeastTwoDieOnWindowPatterEffect check= new CheckIfThereIsAtLeastTwoDieOnWindowPatterEffect("checkIfThereIsAtLeastTwoDieOnWindowPatter");
        check.setToolCard(toolCardMock);
        check.perform(toolCardMock.getPlayer());
