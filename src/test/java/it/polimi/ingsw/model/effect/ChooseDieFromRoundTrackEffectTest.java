...
class ChooseDieFromRoundTrackEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        ChooseDieFromRoundTrackEffect chooseDieFromRoundTrackEffect = new ChooseDieFromRoundTrackEffect("chooseDieFromRoundTrack");
        chooseDieFromRoundTrackEffect.setToolCard(toolCardMock);
        chooseDieFromRoundTrackEffect.perform();
