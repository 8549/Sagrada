...
class ChooseIfPlaceDieOrPlaceDieInDraftPoolEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        ChooseIfPlaceDieOrPlaceDieInDraftPoolEffect chooseIfPlace=  new ChooseIfPlaceDieOrPlaceDieInDraftPoolEffect("chooseIfPlaceDieOrPlaceDieInDraftPool");
        chooseIfPlace.setToolCard(toolCardMock);
        chooseIfPlace.perform();
