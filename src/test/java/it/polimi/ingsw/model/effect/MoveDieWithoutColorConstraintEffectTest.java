...
class MoveDieWithoutColorConstraintEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        MoveDieWithoutColorConstraintEffect effect12 = new MoveDieWithoutColorConstraintEffect("moveDieWithoutColorConstraint");
