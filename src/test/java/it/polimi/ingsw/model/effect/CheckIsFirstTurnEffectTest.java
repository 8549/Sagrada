...
class CheckIsFirstTurnEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        CheckIsFirstTurnEffect checkIsFirstTurnEffect = new CheckIsFirstTurnEffect("checkIsFirstTurn");
        checkIsFirstTurnEffect.setToolCard(toolCardMock);
        checkIsFirstTurnEffect.perform(toolCardMock.round);
