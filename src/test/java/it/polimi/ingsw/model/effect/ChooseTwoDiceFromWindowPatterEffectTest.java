...
class ChooseTwoDiceFromWindowPatterEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock= new ToolCardMock();
        toolCardMock.setToolCardMock();
        ChooseTwoDiceFromWindowPatterEffect chese=  new ChooseTwoDiceFromWindowPatterEffect("chooseTwoDiceFromWindowPattern");
        chese.setToolCard(toolCardMock);
        chese.perform();
