...
class ChooseDieValueEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        ChooseDieValueEffect chooseDieValueEffect = new ChooseDieValueEffect("chooseDieValue");
        chooseDieValueEffect.setToolCard(toolCardMock);
        chooseDieValueEffect.perform(toolCardMock.getDie());
    ...
    private class ToolCardMock extends it.polimi.ingsw.model.ToolCard {
        ...
        public void setToolCardMock() {
            ...
            id = 12;
            when = "always";
            die = getBoard().getDraftPool().get(1);
