...
class ChooseToMoveOneOrTwoDiceEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock= new ToolCardMock();
        toolCardMock.setToolCardMock();
        ChooseToMoveOneOrTwoDiceEffect choose= new ChooseToMoveOneOrTwoDiceEffect("chooseToMoveOneOrTwoDice");
        choose.setToolCard(toolCardMock);
        choose.perform();
