...
class PlaceDieEffectTest {
    ...
    void testPerform() {
        ...
        PlaceDieEffect effect12 = new PlaceDieEffect("placeDie");
        effect12.setToolCard(toolCardMock);
        effect12.perform(toolCardMock.getTurn(), true);
        assertTrue(toolCardMock.isEverythingOk());
        effect12.perform(toolCardMock.getTurn(), false);
        assertTrue(toolCardMock.isEverythingOk());
    }
