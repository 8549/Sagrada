...
class MoveDieWithSameColorAsDieFromRoundTrackEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        MoveDieWithSameColorAsDieFromRoundTrackEffect effect12 =  new MoveDieWithSameColorAsDieFromRoundTrackEffect("moveDieWithSameColorAsDieFromRoundTrack");
        effect12.setToolCard(toolCardMock);
        effect12.perform(toolCardMock.getDie(), 0, 0, toolCardMock.getBoard());
    ...
    private class ToolCardMock extends it.polimi.ingsw.model.ToolCard {
        ...
        public void setToolCardMock() {
            ...
            everythingOk = true;
            die = new Die(SagradaColor.RED);
            List<Die> dice= new ArrayList<>();
            dice.add(die);
            board.setRoundTrack();
            board.getRoundTrack().addRound(dice);
