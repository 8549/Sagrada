...
class ChooseDieFromDraftPoolEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        ChooseDieFromDraftPoolEffect chooseDieFromDraftPoolEffect = new ChooseDieFromDraftPoolEffect("chooseDieFromDraftPool");
        chooseDieFromDraftPoolEffect.setToolCard(toolCardMock);
        chooseDieFromDraftPoolEffect.perform();
