...
class MoveDieWithoutNumberConstraintEffectTest {

    @Test
    void testPerform() {
        ToolCardMock toolCardMock = new ToolCardMock();
        toolCardMock.setToolCardMock();
        MoveDieWithoutNumberConstraintEffect effect12 = new MoveDieWithoutNumberConstraintEffect("moveDieWithoutNumberConstraint");
